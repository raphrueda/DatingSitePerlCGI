...
sub navigation {
	return  "<nav class=\"navbar navbar-default\" role=\"navigation\">", "\n",
		...
		"        <div class=\"row\">", "\n",
		"            <div class=\"col-md-5\">", "\n",
		"                <span class=\"navbar-brand\">LOVE2041 <small><span class=\"glyphicon glyphicon-heart\"></span> Find yo bae.</small></span>", "\n",
		"            </div>", "\n",
		"	     <div class=\"col-md-2\" style=\"padding-top:2px\"><button type=\"submit\" name=\"Match Me\" value=\"Match Me\" class=\"btn btn-danger\">Find my Soulmate</div>", "\n",
		"	     <div class=\"col-md-5\">", "\n",
